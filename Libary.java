   ...
   public final List<String> availableBooks;
    ...
    private JPanel panel,leftPanel,rightPanel;
     private Font font;
        ...
        private String[][] rows={
                                  ...
                                  {  "Himu","Humayun Ahmed","350","4.3"},
                                  {  "Shesher Kabita","Rabindranath Tagore","330","4"},
                                  {  "Opekkha","Humayun Ahmed","300","4.5"},
    ...
    public Libary(){
       ...
       availableBooks = new ArrayList<>();
        availableBooks.add("Himu");
        availableBooks.add("Shesher Kabita");
       ...
       JFrame framelog=new JFrame("Login Frame");
        ...
        jb.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(username.equals("omor")&&password.equals("1234"))
      ...
      back.addActionListener(new ActionListener (){
       ...
       public void userdeshboardsubframe(){
         ...
         JLabel labeldb1=new JLabel("Personal Information");
            ...
            JTextArea deshboard1=new JTextArea("Name:Md Omor Faruq ;\nID:2022-1-60-335\nDepartment:CSE\nSamester:Fall-23");
